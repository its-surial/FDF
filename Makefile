...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/02/12 19:54:32 by surkumar          #+#    #+#              #
#    Updated: 2023/02/22 21:42:53 by surkumar         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# Source
SRC_FILES =		main.c					check_args.c			color.c				\
				minilib_hooks.c			minilib_main.c			minilib_utils.c		\
				control.c				sketch.c				sketch_utils.c		\
				error_handle.c			maps.c					map_utils.c			\
...
$(NAME): $(LFT_NAME) $(LMLX_NAME) $(OBJ)
	...
	@echo $(BLU) $(BOLD)"Compilation successful !"$(NOCOL)
