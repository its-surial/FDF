...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/14 17:55:14 by surkumar          #+#    #+#             */
/*   Updated: 2023/02/22 20:32:08 by surkumar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// check_args.c
void	check_args(t_map **map, int ac, char **av);
...
// color.c
int		coloring(t_point current, t_point start, t_point end, t_point delta);
